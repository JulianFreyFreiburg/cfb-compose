...
curl -fSL -o geonetwork.war \
     https://sourceforge.net/projects/geonetwork/files/GeoNetwork_opensource/v3.6.0/geonetwork.war/download && \
     mkdir -p geonetwork && \
...
if [ "$1" = 'catalina.sh' ]; then
	...
	#Setting host (use $POSTGRES_DB_HOST if it's set, otherwise use "localhost")
